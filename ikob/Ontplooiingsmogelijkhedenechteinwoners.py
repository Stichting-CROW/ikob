...
def bereken_potenties (Matrix, Arbeidsplaatsen, Beroepsbevolkingsverdeling, Beroepsbevolkingaandeel, inkgr, gr):
    Dezegroeplijst = []
...
def bereken_potenties_nietwerk (Matrix, Bestemmingen, Inwonersverdeling, Inwonersaandeel, gr):
    Dezegroeplijst = []
    for i in range ( len ( Matrix ) ):
        Gewogenmatrix = []
                                    ...
                                    for srtbr in soortbrandstof:
                                        ...
                                        if mot == 'werk':
                                            Dezegroeplijst1 = bereken_potenties(Matrix, Arbeidsplaatsen,
                                                                                Verdelingstransmatrix,
                                                                                Inkomenstransverdeling[
                                                                                    inkgroepen.index(inkgr)], inkgr, gr)
                                        else:
