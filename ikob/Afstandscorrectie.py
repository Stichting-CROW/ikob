            ...
            for mot in motieven:
                    ...
                    for afstsrt in Afstandssoorten:
                        ...
                        for vk in voorkeuren:
                            ...
                            if mot == 'werk':
                                ...
                                Dezegroeplijst = bereken_afstanden_nietwerk(Matrix, Beroepsbevolkingtotalen, Afstanden,
                                                                        Bereik, inkgr)
                ...
                for afstsrt in Afstandssoorten:
                    ...
                    for i in range (len(Beroepsbevolkingperklasse)):
                        ...
                        for j in range (len(Beroepsbevolkingperklasse[0])):
                            if Beroepsbevolkingperklasse[i][j]>0:
                                Generaalmatrixproduct[i].append(round(Generaaltotaaltrans[i][j]*Beroepsbevolkingperklasse[i][j]))
                            else:
                                Generaalmatrixproduct[i].append(0)
