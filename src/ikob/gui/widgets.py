...
if __name__ == "__main__":
  ...
  """
    ...
    widgets.append(F1)
    R1 = Radiobutton(F1, text="Option 1", variable=var, value=12, command=sel)
    widgets.append(R1)
    R2 = Radiobutton(F1, text="Option 2", variable=var, value=34, command=sel)
    widgets.append(R2)
    R3 = Radiobutton(F1, text="Option 3", variable=var, value=56, command=sel)
    widgets.append(R3)
